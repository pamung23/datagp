                            ...
                            <form
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="uraian_kasus" name="uraian_kasus" rows="4"
                                        placeholder="Masukkan uraian kasus"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tersangka" name="tersangka"
                                        placeholder="Masukkan tersangka" value="{{ $data->tersangka }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="barang_bukti">Barang Bukti</label>
                                    <input type="text" class="form-control" id="barang_bukti" name="barang_bukti"
                                        placeholder="Masukkan barang bukti" value="{{ $data->barang_bukti }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="lidik" name="lidik" required>
                                        <option value="Nihil" {{ $data->lidik == 'Nihil' ? 'selected' : '' }}>Nihil
                                        </option>
                                        <option value="Iya" {{ $data->lidik == 'Iya' ? 'selected' : '' }}>Iya
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sidik" name="sidik" required>
                                        <option value="Nihil" {{ $data->sidik == 'Nihil' ? 'selected' : '' }}>Nihil
                                        </option>
                                        <option value="Iya" {{ $data->sidik == 'Iya' ? 'selected' : '' }}>Iya
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sp3" name="sp3" required>
                                        <option value="Nihil" {{ $data->sp3 == 'Nihil' ? 'selected' : '' }}>Nihil
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="p21" name="p21" required>
                                        <option value="Nihil" {{ $data->p21 == 'Nihil' ? 'selected' : '' }}>Nihil
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="vonis" name="vonis" required>
                                        <option value="Nihil" {{ $data->vonis == 'Nihil' ? 'selected' : '' }}>Nihil
                                        </option>
                                        <option value="Iya" {{ $data->vonis == 'Iya' ? 'selected' : '' }}>Iya
                                        </option>
