...
<script>
    ...
    const nama_lk = "{{ $data->nama_lk }}"; // Ganti dengan cara akses data yang benar
    const nama_ilmiah = "{{ $data->nama_ilmiah }}"; 
    const jantan = "{{ $data->jantan }}"; 
    const betina = "{{ $data->betina }}"; 
    const belum_diketahui = "{{ $data->belum_diketahui }}"; 
  ...
  var datajsonJSON = L.geoJson(datajson, {
    ...
    const marker = L.marker([latitude, longitude])
        .addTo(map)
        .bindPopup(`<b>Triwulan: ${triwulan}</b><br><b>Nama Lembaga Konservasi: ${nama_lk}</b><br><b>Nama Ilmiah: ${nama_ilmiah}</b><br><b>Jantan: ${jantan}</b><br><b>Betina: ${betina}</b><br><b>Belum DiKetahui: ${belum_diketahui}</b><br><b>Jumlah: ${jumlah}</b><br>Latitude: ${latitude}<br>Longitude: ${longitude}`)
