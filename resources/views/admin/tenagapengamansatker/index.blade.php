...
@section('title', 'Tenaga Pengamanan Hutan Per Satuan Kerja')
...
<div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area br-6">
            <form action="{{ route('tenagapengamansatker.index') }}" method="GET" class="mb-4 mt-3 ml-4">
                <div class="form-group d-flex">
                    ...
                    <div class="ml-auto mr-2">
                        @if ($year)
                        <a href="{{ route('tenagapengamansatker.export', ['triwulan' => $triwulan, 'year' => $year]) }}"
            ...
            <table id="zero-config" class="table table-striped" style="width:100%">
                <thead>
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th class="text-center">Polhut (Orang)</th>
                        <th class="text-center">PPNS (Orang)</th>
                        <th class="text-center">TPHL (Orang)</th>
                        <th class="text-center">MMP (Orang)</th>
                        <th></th>
                        <th></th>
                        @if($triwulan !== 'all')
                        <th></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $item->polhut }}</td>
                        <td class="text-center">{{ $item->ppns }}</td>
                        <td class="text-center">{{ $item->tphl }}</td>
                        <td class="text-center">{{ $item->mmp }}</td>
