...
@section('title', 'Penanganan Jenis Asing Invasif (IAS) di Kawasan Konservasi')
    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area br-6">
            ...
            <table id="zero-config" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    @foreach ($penanganan_jenis as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form
                                action="{{ route('penangananjenis.destroy', ['semester' => $semester, 'id' => $item->id]) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
...
<script>
    // Ambil elemen select semester
        ...
        semesterSelect.addEventListener('change', function() {
            ...
            const baseUrl = "{{ route('penangananjenis.index') }}";
