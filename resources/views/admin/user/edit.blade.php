                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            <form method="POST" action="{{ route('user.update', $user->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="hp" name="hp" value="{{ $user->hp }}"
                                        required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="level" name="level" required>
                                        ...
                                        <option value="Balai" {{ $user->level === 'Balai' ? 'selected' : '' }}>
                                            Balai
                                        </option>
                                        <option value="Wilayah Cianjur" {{ $user->level === 'Wilayah Cianjur' ?
                                            'selected' : '' }}>
                                            Wilayah Cianjur
                                        </option>
                                        <option value="Wilayah Sukabumi" {{ $user->level === 'Wilayah Sukabumi' ?
                                            'selected' : '' }}>
                                            Wilayah Sukabumi
                                        </option>
                                        <option value="Wilayah Bogor" {{ $user->level === 'Wilayah Bogor' ? 'selected' :
                                            '' }}>
                                            Wilayah Bogor
                                        </option>
                                    </select>
                                ...
                                <div class="form-group resort-container">
                                    ...
                                    <select class="form-control" id="resort_id" name="resort_id">
                                        ...
                                        <option value="{{ $resort->id }}" {{ $user->resort_id === $resort->id ?
                                            'selected' : '' }}>
                                            {{ $resort->nama }}
                                        </option>
                                        @endforeach
