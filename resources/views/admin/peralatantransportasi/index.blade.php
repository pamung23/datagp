...
@section('title', 'Peralatan Transportasi Pengendalian Kebakaran Hutan')
            ...
            <table id="zero-config" class="table table-striped" style="width:100%">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="text-center" colspan="2">Mobil Patroli/Pick Up</th>
                        <th class="text-center" colspan="2">Mobil Operasional/ Pick Up</th>
                        <th class="text-center">Lain-Lain</th>
                        <th class="text-center" colspan="2">Boat</th>
                ...
                <tbody>
                    @foreach ($peralatan_transportasi as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form
                                action="{{ route('peralatantransportasi.destroy', ['semester' => $semester, 'id' => $item->id]) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
...
<script>
    // Ambil elemen select semester
        ...
        semesterSelect.addEventListener('change', function() {
            ...
            const baseUrl = "{{ route('peralatantransportasi.index') }}";
