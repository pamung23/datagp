...
@section('title', 'Rincian Barang Milik Negara (Gabungan Intrakomptabel dan Ekstrakomptabel) ' . $semester)
                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form action="{{ route('bmn.store', ['semester' => $semester]) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="uraian"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="nilai1"
                                        placeholder="Masukkan Nilai (Rp)" required>
                                </div>
                                <div class="thick-hr"></div>
                                <h6>Mutasi</h6>
                                <div class="thick-hr"></div>
