@extends('layouts.app')
@section('title', 'Tambah Data Pengusahaan Pemanfaatan Jasa Lingkungan Wisata Alam ' . $triwulan)
@push('styles')
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12" style="margin-left: 12px;">
                            ...
                            <h4>Tambah Data Pengusahaan Pemanfaatan Jasa Lingkungan Wisata Alam</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form action="{{ route('iupjswa.store', ['triwulan' => $triwulan]) }}" method="POST">
                                @csrf
                                <input type="hidden" name="triwulan" value="{{ $triwulan }}">

                                <div class="form-group">
                                    <label for="nama_zona_blok_pemanfaatan">Nama Zona Blok Pemanfaatan</label>
                                    <input type="text" class="form-control" name="nama_zona_blok_pemanfaatan" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="iupswa_nama_perusahaan" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="iupjwa_nama_pemegang_izin" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" name="iupjwa_jenis_jasa" required>
                                        ...
                                        <option value="Jasa Perjalanan Wisata">Jasa Perjalanan Wisata</option>
                                        <option value="Jasa Informasi Wisata">Jasa Informasi Wisata</option>
                                        <option value="Jasa Penyedia Makan/Minum">Jasa Penyedia Makan/Minum</option>
                                    </select>
                                </div>
                                <div class="form-group">
