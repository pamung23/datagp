...
@section('title', 'Tambah Data Kerjasama Penyelenggaraan KSA dan KPA ' . $semester)
                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            @endif
                            <form action="{{ route('kerjasama.store', ['semester' => $semester]) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tipe_kerjasama" name="tipe_kerjasama" required>
                                        ...
                                        <option value="Penguatan Fungsi">Penguatan Fungsi</option>
                                        <option value="Pembangunan Strategis">Pembangunan Strategis</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ruang_lingkup_kerjasama"
                                        name="ruang_lingkup_kerjasama" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nomor_mou" name="nomor_mou" required>
                                    @error('nomor_mou')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
