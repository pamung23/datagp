                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 " style="margin-left: 12px;">
                            ...
                            <h4>Edit informasi kawasan konservasi yang mendapat penetapan status internasional sebagai
                                cagar biosfer.</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form
                                action="{{ route('kawasankonservasi.update', ['semester' => $semester, 'id' => $data->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_cagar_biosfer"
                                        placeholder="Masukkan nama cagar biosfer"
                                        value="{{ $data ->nama_cagar_biosfer }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="tahun_penetapan">Tahun Penerbitan Izin Usaha</label>
                                    <select class="form-control selectpicker" name="tahun_penetapan" required>
                                        <option value="">Pilih Tahun</option>
                                        @foreach($years as $year)
                                        <option value="{{ $year }}" {{ $data->tahun_penetapan == $year ?
