...
@section('title', 'Tambah Data Kerjasama Teknis Bidang KSDAE ' . $semester)
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12" style="margin-left: 12px;">
                            ...
                            <h4>Tambah Data Kerjasama Teknis Bidang KSDAE</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            @endif
                            <form action="{{ route('kerjasamateknis.store', ['semester' => $semester]) }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tipe_mitra" name="tipe_mitra" required>
                                    @error('tipe_mitra')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="jenis_kerja_sama"
                                        name="jenis_kerja_sama" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="judul_kerja_sama"
                                        name="judul_kerja_sama" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ruang_lingkup_kerja_sama"
                                        name="ruang_lingkup_kerja_sama" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_mou_pks" name="no_mou_pks" required>
                                    @error('no_mou_pks')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="persetujuan_kerja_sama"
                                        name="persetujuan_kerja_sama" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="basicFlatpickr1" class="form-control flatpickr flatpickr-input active"
                                        ...
                                        name="tanggal_awal_berlaku" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="basicFlatpickr2" class="form-control flatpickr flatpickr-input active"
                                        ...
                                        id="tanggal_akhir_berlaku" name="tanggal_akhir_berlaku" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lokasi_kerja_konservasi"
                                        name="lokasi_kerja_konservasi" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lokasi_kerja_provinsi"
                                        name="lokasi_kerja_provinsi" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="luas_areal_kerja_sama"
                                        name="luas_areal_kerja_sama" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="komitmen_pendanaan"
                                        name="komitmen_pendanaan" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ikp_ikk_berkaitan"
                                        name="ikp_ikk_berkaitan" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="status_kerja_sama"
                                        name="status_kerja_sama" required>
