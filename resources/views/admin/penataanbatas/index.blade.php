...
@section('title', 'Penataan Batas Kawasan Konservasi')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form
                                action="{{ route('penataanbatas.destroy', ['semester' => $semester, 'id' => $item->id]) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
...
<script>
    // Ambil elemen select semester
        ...
        semesterSelect.addEventListener('change', function() {
            ...
            const baseUrl = "{{ route('penataanbatas.index') }}";
