...
@section('title', 'Tambah Data Potensi Wisata Alam di Kawasan Konservasi ' . $triwulan)
        ...
        <div class="widget-content widget-content-area">
            <div class="row">
                <div class="col-lg-7 col-12 mx-auto">
                    ...
                    @endif
                    <form action="{{ route('potensiodtwa.store', ['triwulan' => $triwulan]) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="luas_zona_blok_pemanfaatan" step="0.01"
                                required>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenis_odtwa" required>
                                ...
                                <option value="Landscape/Seascape">Landscape/Seascape</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenis_atraksi_wisata" required>
                                ...
                                <option value="Tracking/hiking/climbing">Tracking/hiking/climbing</option>
                                <option value="Berkemah">Berkemah</option>
                                <option value="Caving">Caving</option>
                                <option value="Pengamatan hidupan liar">Pengamatan hidupan liar</option>
                                <option value="Memancing">Memancing</option>
                                <option value="Canopy trail">Canopy trail</option>
                                <option value="Outbond training">Outbond training</option>
                                <option value="Lain-lain">Lain-lain</option>
                            </select>
                        </div>
                        <div class="form-group">
                                    ...
                                    <tr class="prasarana-item">
                                        <td>
                                            <input type="text" name="jenis_prasarana[]" class="form-control"
                                                placeholder="Jenis Sarana/Prasarana" required>
                                        </td>
                                        <td>
