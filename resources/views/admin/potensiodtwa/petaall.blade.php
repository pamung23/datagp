                ...
                Object.keys(allDataByQuarter).forEach(triwulan => {
                    ...
                    dataForQuarter.forEach(dataPoint => {
                        ...
                        const marker = L.marker([dataPoint.latitude, dataPoint.longitude], { icon: icon })
                            .bindPopup(`<b>Nama Zona: ${dataPoint.nama_zona_blok_pemanfaatan}</b><br><b>Triwulan: ${dataPoint.triwulan}</b><br>Tahun: ${year}<br>Latitude: ${dataPoint.latitude}<br>Longitude: ${dataPoint.longitude}`)
