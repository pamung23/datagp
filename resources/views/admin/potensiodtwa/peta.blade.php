...
<script>
    ...
    const nama_zona_blok_pemanfaatan = "{{ $data->nama_zona_blok_pemanfaatan }}"; // Ganti dengan cara akses data yang benar
  ...
  var datajsonJSON = L.geoJson(datajson, {
    ...
    const marker = L.marker([latitude, longitude])
        .addTo(map)
        .bindPopup(`<b>Nama Zona: ${nama_zona_blok_pemanfaatan}</b><br><b>Triwulan: ${triwulan}</b><br>Latitude: ${latitude}<br>Longitude: ${longitude}`)
