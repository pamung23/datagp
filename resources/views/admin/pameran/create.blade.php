                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            <form action="{{ route('pameran.store') }}" method="POST" id="pameran-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jenis" placeholder="Masukkan Jenis Publikasi dan Aktivitas Promosi" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="penyelenggara" placeholder="Masukkan Penyelenggara Pameran" required>
                                </div>
                                <div class="form-group">
                                    <label for="sumber">Sumber Pembiayaan</label>
                                    <input type="text" class="form-control"  name="sumber" placeholder="Masukkan Sumber Pembiayaan" required>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="keterangan">Keterangan</label>
                                    <textarea class="form-control" name="keterangan" rows="3" placeholder="Masukkan keterangan (Optional)"></textarea>
                                </div>
