                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form action="{{ route('pameran.update', ['semester'=> $semester, 'id' => $data->id]) }}"
                                method="POST" id="pameran-form">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jenis"
                                        placeholder="Masukkan Jenis Publikasi dan Aktivitas Promosi"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="penyelenggara"
                                        placeholder="Masukkan Penyelenggara Pameran" value="{{ $data->penyelenggara }}"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="sumber">Sumber Pembiayaan</label>
                                    <input type="text" class="form-control" name="sumber"
                                        placeholder="Masukkan Sumber Pembiayaan" value="{{ $data->sumber }}" required>
                                </div>
                                <hr>
                                <div class="form-group">
