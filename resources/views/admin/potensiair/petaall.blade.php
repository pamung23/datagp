...
<div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        ...
        <div class="widget-header">
            <div class="row py-2 m-auto">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right" style="margin-top: 20px">
                    <a href="{{ route('potensiair.index') }}" class="btn btn-outline-primary btn-sm ">Kembali</a>
                </div>
            </div>
    ...
    Object.keys(allDataByQuarter).forEach(triwulan => {
        ...
        dataForQuarter.forEach(dataPoint => {
            ...
            .bindPopup(`<b>Nama Sumber Air: ${dataPoint.nama_sumber_air}</b><br><b>Debit: ${parseFloat(dataPoint.debit).toLocaleString('id-ID')}</b><br><b>Massa Air: ${parseFloat(dataPoint.massa_air).toLocaleString('id-ID')}</b><br><b>Triwulan: ${dataPoint.triwulan}</b><br>Latitude: ${dataPoint.latitude}<br>Longitude: ${dataPoint.longitude}`)
