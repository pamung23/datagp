...
@section('title', 'Edit Data Potensi Pemanfaatan Air di Kawasan Konservasi - Triwulan ' . $triwulan)
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 " style="margin-left: 12px;">
                            ...
                            <h4>Edit Data Potensi Pemanfaatan Air di Kawasan Konservasi</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form
                                action="{{ route('potensiair.update', ['triwulan' => $triwulan, 'id' => $data->id]) }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="debit" pattern="[-.,\d]+"
                                        ...
                                        oninput="limitDecimalPlaces(this, 4)" value="{{ $data->debit }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="massa_air" pattern="[-.,\d]+"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44 || event.charCode === 46"
                                        oninput="limitDecimalPlaces(this, 4)" value="{{ $data->massa_air }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="energi_air">Energi Air</label>
                                    <input type="text" class="form-control" name="energi_air" pattern="[-.,\d]+"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44 || event.charCode === 46"
                                        oninput="limitDecimalPlaces(this, 4)" value="{{ $data->energi_air }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="basicFlatpickr" type="date"
                                        class="form-control flatpickr flatpickr-input" name="tanggal"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pengusahaan_pihak_iii"
                                        value="{{ $data->pengusahaan_pihak_iii }}" step="0.01" required>
                                </div>
                                <div class="form-group">
