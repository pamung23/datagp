...
<script>
    ...
    const nama_sumber_air = "{{ $data->nama_sumber_air }}";
    const massa_air ="{{ $data->massa_air }}";
  ...
  var datajsonJSON = L.geoJson(datajson, {
    ...
    .addTo(map)
    .bindPopup(`<b>Nama Sumber Air: ${nama_sumber_air}</b><br><b>Debit: ${parseFloat(debit).toLocaleString('id-ID')}</b><br><b>Massa Air: ${parseFloat(massa_air).toLocaleString('id-ID')}</b><br><b>Triwulan: ${triwulan}</b><br>Latitude: ${latitude}<br>Longitude: ${longitude}`)
