...
@section('title', 'Edit Data Kawasan Konservasi ' . $triwulan)
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 " style="margin-left: 12px;">
                            ...
                            <h4>Edit Data Kawasan Konservasi</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form
                                action="{{ route('penetapankk.update', ['triwulan' => $triwulan, 'id' => $data->id]) }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nomor_sk_parsial"
                                        value="{{ $data->nomor_sk_parsial }}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input id="basicFlatpickr1" class="form-control flatpickr flatpickr-input "
                                        ...
                                        name="tanggal_sk_parsial" value="{{ $data->tanggal_sk_parsial }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="luas_ha_parsial">Luas (ha) Parsial</label>
                                    <input type="text" class="form-control" name="luas_ha_parsial"
                                        value="{{ $data->luas_ha_parsial }}" pattern="[-.,\d]+"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nomor_sk_provinsi"
                                        value="{{ $data->nomor_sk_provinsi }}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input id="basicFlatpickr2" class="form-control flatpickr flatpickr-input "
                                        ...
                                        name="tanggal_sk_provinsi" value="{{ $data->tanggal_sk_provinsi }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="luas_ha_provinsi">Luas (ha) Provinsi</label>
                                    <input type="text" class="form-control" name="luas_ha_provinsi"
                                        value="{{ $data->luas_ha_provinsi }}" pattern="[-.,\d]+"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44 || event.charCode === 46"
                                        required>
                                </div>
                                <div class="thick-hr"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nomor_sk_kawasan"
                                        value="{{ $data->nomor_sk_kawasan }}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input id="basicFlatpickr3" class="form-control flatpickr flatpickr-input "
                                        ...
                                        name="tanggal_sk_kawasan" value="{{ $data->tanggal_sk_kawasan }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="luas_ha_kawasan">Luas (ha) Kawasan</label>
                                    <input type="text" class="form-control" name="luas_ha_kawasan"
                                        value="{{ $data->luas_ha_kawasan }}" pattern="[-.,\d]+"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44 || event.charCode === 46"
                                        required>
                                </div>
                                <div class="form-group">
