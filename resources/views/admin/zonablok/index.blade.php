...
@section('title', 'Zona dan Blok Tradisional Kawasan Konservasi')
        ...
        <div class="widget-header">
            <div class="row py-2 m-auto">
                <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                    <h4>Zona dan Blok Tradisional Kawasan Konservasi</h4>
                </div>
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right m-auto">
                    <a href="{{ route('zonablok.create') }}" class="btn btn-outline-primary btn-sm">Tambah
                        Data</a>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area br-6">
            <form action="{{ route('zonablok.index') }}" method="GET" id="year-form" class="mb-4 ml-auto">
                ...
                <a href="{{ route('zonablok.export', ['year' => $selectedYear]) }}"
            ...
            <table id="zero-config" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('zonablok.edit', $data->id) }}"
                                class="btn btn-outline-warning btn-sm">Edit</a>
                            <form action="{{ route('zonablok.destroy', $data->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
...
<script>
    $(document).ready(function () {
        ...
        yearSelect.addEventListener('change', function () {
            ...
            const baseUrl = "{{ route('zonablok.index') }}";
