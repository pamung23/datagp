...
@section('title', 'Edit Data Sebaran Pejabat Fungsional Tertentu Menurut Fungsi dan Jenjang Jabatan' . $semester)
@push('styles')
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12" style="margin-left: 12px;">
                            ...
                            <h4>Edit Data Sebaran Pejabat Fungsional Tertentu Menurut Fungsi dan Jenjang Jabatan</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            @endif
                            <form
                                action="{{ route('fungsional.update', ['semester' => $semester, 'id' => $data->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="calon_terampil_perencana"
                                        placeholder="" oninput="hitungTotal()"
                                        value="{{ $data->calon_terampil_perencana }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="terampil_perencana">Terampil</label>
                                    <input type="number" class="form-control" name="terampil_perencana" placeholder=""
                                        oninput="hitungTotal()" value="{{ $data->terampil_perencana }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="calon_ahli_perencana">Calon Ahli</label>
                                    <input type="number" class="form-control" name="calon_ahli_perencana"
                                        value="{{ $data->calon_ahli_perencana }}" placeholder="" oninput="hitungTotal()"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="ahli_perencana">Ahli</label>
                                    <input type="number" class="form-control" name="ahli_perencana" placeholder=""
                                        oninput="hitungTotal()" value="{{ $data->ahli_perencana }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="jumlah_perencana">Jumlah (Orang)</label>
                                    <input type="number" class="form-control" name="jumlah_perencana"
                                        id="jumlah_perencanana" placeholder="" oninput="hitungTotal()"
                                        value="{{ $data->jumlah_perencana }}" readonly>
                                </div>
                                <div class="thick-hr"></div>
