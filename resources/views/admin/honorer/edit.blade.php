...
@section('title', 'Edit Data Sebaran Pegawai Tidak Tetap Menurut Tingkat Pendidikan dan Jenis Kelamin ' . $semester)
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            ...
                            <h4>Edit Data Sebaran Pegawai Tidak Tetap Menurut Tingkat Pendidikan dan Jenis Kelamin</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form action="{{ route('honorer.update', ['semester' => $semester, 'id' => $data->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
