...
@section('title', 'Sebaran Pegawai Tidak Tetap Menurut Tingkat Pendidikan dan Jenis Kelamin')
        ...
        <div class="widget-header">
            <div class="row py-2 m-auto">
                <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                    ...
                    <h4>Sebaran Pegawai Tidak Tetap Menurut Tingkat Pendidikan dan Jenis Kelamin</h4>
                </div>
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right m-auto">
                    <a href="{{ route('honorer.create', ['semester' => $semester]) }}"
                        class="btn btn-outline-primary btn-sm">Tambah Data</a>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area br-6">
            <form action="{{ route('honorer.index') }}" method="GET" class="mb-4 mt-3 ml-4">
                <div class="form-group d-flex">
                    ...
                    <div class="ml-auto mr-2">
                        @if ($year)
                        <a href="{{ route('honorer.export', ['semester' => $semester, 'year' => $year]) }}"
            ...
            <table id="zero-config" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" colspan="10">Jenjang Pendidikan</th>
                    ...
                    <tr>
                        ...
                        <th class="text-center" colspan="2">Sarjana Muda (D4)</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('honorer.edit', ['semester' => $semester, 'id' => $item->id]) }}"
                                class="btn btn-outline-warning btn-sm">Edit</a>
                            <form action="{{ route('honorer.destroy', ['semester' => $semester, 'id' => $item->id]) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
...
<script>
    $('#zero-config').DataTable({
        ...
        semesterSelect.addEventListener('change', function() {
            ...
            const baseUrl = "{{ route('honorer.index') }}";
