                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            ...
                            <h4>Tambah Data Rekontruksi Batas Kawasan Konservasi</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            @endif
                            <form action="{{ route('rekontruksibatas.store', ['semester' => $semester]) }}"
                                method="POST">
                                @csrf
                                <input type="hidden" name="semester" value="{{ $semester }}">
                                <h6>Rekontruksi Batas Kawasan Konservasi</h6>
                                ...
                                <h6>Pelaksanaan Rekonstruksi Batas</h6>
                                <div class="form-group">
