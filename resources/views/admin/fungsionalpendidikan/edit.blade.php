...
@section('title', 'Edit Data Sebaran Pejabat Fungsional Tertentu Menurut Fungsi, Tingkat Pendidikan dan Jenis Kelamin'
. $semester)
@push('styles')
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12" style="margin-left: 12px;">
                            ...
                            <h4>Edit Data Sebaran Pejabat Fungsional Tertentu Menurut Fungsi, Tingkat Pendidikan dan
                                Jenis Kelamin</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            @endif
                            <form
                                action="{{ route('fungsionalpendidikan.update', ['semester' => $semester, 'id' => $data->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="semester" value="{{ $semester }}">
                                <div class="form-group">
                                    <label for="jenis_jabatan_fungsional">Jenis Jabatan Fungsional Tertentu</label>
                                    <input type="text" class="form-control" name="jenis_jabatan_fungsional"
                                        placeholder="Masukkan Jenis Jabatan Fungsional" id="jenis_jabatan_fungsional"
                                        required value="{{ $data->jenis_jabatan_fungsional }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="l_s3" id="l_s3"
                                        placeholder="Masukkan Laki-laki" required value="{{ $data->l_s3 }}">
                                </div>
                                <div class="form-group">
                                    <label for="p_s3">Perempuan</label>
                                    <input type="number" class="form-control" name="p_s3"
                                        placeholder="Masukkan Perempuan" id="p_s3" required value="{{ $data->p_s3 }}">
                                </div>
                                <div class="thick-hr"></div>
                                <h6>S2</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="l_s2" id="l_s2"
                                        value="{{ $data->l_s2 }}" placeholder="Masukkan Laki-laki" required>
                                </div>
                                <div class="form-group">
                                    <label for="p_s2">Perempuan</label>
                                    <input type="number" class="form-control" name="p_s2" id="p_s2"
                                        value="{{ $data->p_s2 }}" placeholder="Masukkan Perempuan" required>
                                </div>
                                <div class="thick-hr"></div>
                                <h6>S1/D4</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="l_s1" id="l_s1"
                                        value="{{ $data->l_s1 }}" placeholder="Masukkan Laki-laki" required>
                                </div>
                                <div class="form-group">
                                    <label for="p_s1">Perempuan</label>
                                    <input type="number" class="form-control" name="p_s1" id="p_s1"
                                        value="{{ $data->p_s1 }}" placeholder="Masukkan Perempuan" required>
                                </div>
                                <div class="thick-hr"></div>
                                <h6>D3</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="l_d3" id="l_d3"
                                        value="{{ $data->l_d3 }}" placeholder="Masukkan Laki-laki" required>
                                </div>
                                <div class="form-group">
                                    <label for="p_d3">Perempuan</label>
                                    <input type="number" class="form-control" name="p_d3" id="p_d3"
                                        value="{{ $data->p_d3 }}" placeholder="Masukkan Perempuan" required>
                                </div>
                                <div class="thick-hr"></div>
                                <h6>SLTA</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="l_slta" id="l_slta"
                                        value="{{ $data->l_slta }}" placeholder="Masukkan Laki-laki" required>
                                </div>
                                <div class="form-group">
                                    <label for="p_slta">Perempuan</label>
                                    <input type="number" class="form-control" name="p_slta" id="p_slta"
                                        value="{{ $data->p_slta }}" placeholder="Masukkan Perempuan" required>
                                </div>
                                <div class="thick-hr"></div>
                                <h6>SLTP</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="l_sltp" id="l_sltp"
                                        value="{{ $data->l_sltp }}" placeholder="Masukkan Laki-laki" required>
                                </div>
                                <div class="form-group">
                                    <label for="p_sltp">Perempuan</label>
                                    <input type="number" class="form-control" name="p_sltp" id="p_sltp"
                                        value="{{ $data->p_sltp }}" placeholder="Masukkan Perempuan" required>
                                </div>
                                <div class="thick-hr"></div>
                                <h6>SD</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="l_sd" id="l_sd"
                                        value="{{ $data->l_sd }}" placeholder="Masukkan Laki-laki" required>
                                </div>
                                <div class="form-group">
                                    <label for="p_sd">Perempuan</label>
                                    <input type="number" class="form-control" name="p_sd" id="p_sd"
                                        value="{{ $data->p_sd }}" placeholder="Masukkan Perempuan" required>
                                </div>
                                <div class="thick-hr"></div>
                                <h6>Jumlah</h6>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="total" placeholder="Total"
                                        id="total" readonly value="{{ $data->total }}">
                                </div>
                                <hr>
                                <div class="form-group">
