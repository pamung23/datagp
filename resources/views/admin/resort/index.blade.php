        ...
        <div class="widget-header">
            <div class="row py-2 m-auto">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right m-auto">
                    <a href="{{ route('resort.create') }}" class="btn btn-outline-primary btn-sm">Tambah Data</a>
                </div>
            </div>
        </div>
                ...
                <table id="zero-config" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->nama}}</td>
                            <td>
                                <a href="{{ route('resort.edit', $item->id) }}"
                                    class="btn btn-outline-warning btn-sm">Edit</a>
                                <form action="{{ route('resort.destroy', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
