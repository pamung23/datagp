...
@section('title', 'Sebaran PNS/CPNS Menurut Tingkat Pendidikan dan Jenis Kelamin')
    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area br-6">
            ...
            <table id="zero-config" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    @foreach ($pegawai_pendidikan as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form
                                action="{{ route('pegawaipendidikan.destroy', ['semester' => $semester, 'id' => $item->id]) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
...
<script>
    $('#zero-config').DataTable({
        ...
        semesterSelect.addEventListener('change', function() {
            ...
            const baseUrl = "{{ route('pegawaipendidikan.index') }}";
