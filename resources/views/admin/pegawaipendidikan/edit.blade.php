                            ...
                            <form
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="laki_doktor"
                                        placeholder="Masukkan Laki-laki" value="{{ $data->laki_doktor }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="form-group">
                                    <label for="perempuan_doktor">Perempuan</label>
                                    <input type="number" class="form-control" name="perempuan_doktor"
                                        placeholder="Masukkan Perempuan" value="{{ $data->perempuan_doktor }}" required
                                        oninput="hitungTotal()">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="laki_master"
                                        placeholder="Masukkan Laki-laki" value="{{ $data->laki_master }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="form-group">
                                    <label for="perempuan_master">Perempuan</label>
                                    <input type="number" class="form-control" name="perempuan_master"
                                        placeholder="Masukkan Perempuan" value="{{ $data->perempuan_master }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="thick-hr"></div>
                                <h6>Sarjana</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="laki_sarjana"
                                        placeholder="Masukkan Laki-laki" value="{{ $data->laki_sarjana }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="form-group">
                                    <label for="perempuan_sarjana">Perempuan</label>
                                    <input type="number" class="form-control" name="perempuan_sarjana"
                                        placeholder="Masukkan Perempuan" value="{{ $data->perempuan_sarjana }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="thick-hr"></div>
                                <h6>Sarjana Muda</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="laki_sarjana_muda"
                                        placeholder="Masukkan Laki-laki" value="{{ $data->laki_sarjana_muda }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="form-group">
                                    <label for="perempuan_sarjana_muda">Perempuan</label>
                                    <input type="number" class="form-control" name="perempuan_sarjana_muda"
                                        placeholder="Masukkan Perempuan" value="{{ $data->perempuan_sarjana_muda }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="laki_slta"
                                        placeholder="Masukkan Laki-laki" value="{{ $data->laki_slta }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="form-group">
                                    <label for="perempuan_SLTA">Perempuan</label>
                                    <input type="number" class="form-control" name="perempuan_slta"
                                        placeholder="Masukkan Perempuan" value="{{ $data->perempuan_slta }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="thick-hr"></div>
                                <h6>SLTP</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="laki_sltp"
                                        placeholder="Masukkan Laki-laki" value="{{ $data->laki_sltp }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="form-group">
                                    <label for="perempuan_sltp">Perempuan</label>
                                    <input type="number" class="form-control" name="perempuan_sltp"
                                        placeholder="Masukkan Perempuan" value="{{ $data->perempuan_sltp }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="thick-hr"></div>
                                <h6>SD</h6>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="laki_sd"
                                        placeholder="Masukkan Laki-laki" value="{{ $data->laki_sd }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="form-group">
                                    <label for="perempuan_sd">Perempuan</label>
                                    <input type="number" class="form-control" name="perempuan_sd"
                                        placeholder="Masukkan Perempuan" value="{{ $data->perempuan_sd }}" required
                                        oninput="hitungTotal()">
                                </div>
                                <div class="thick-hr"></div>
                                <h6>Jumlah</h6>
