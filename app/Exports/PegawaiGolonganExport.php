...
class PegawaiGolonganExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Sebaran PNS/CPNS Menurut Golongan dan Jenis Kelamin',
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $this->currentIndex,
            $row->satker_id,
            $row->laki_iv, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->perempuan_iv, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->laki_iii, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->perempuan_iii,
            $row->laki_ii,
            $row->perempuan_ii,
            $row->laki_i,
