...
class Iupjswaxport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $row->nama_zona_blok_pemanfaatan, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->luas_zona_blok_pemanfaatan, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->iupswa_nama_perusahaan, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->iupswa_tahun_penerbitan,
            $row->iupswa_luas_area,
            $row->iupjwa_nama_pemegang_izin,
            $row->iupjwa_tahun_penerbitan_izin,
            $row->iupjwa_jenis_jasa,
            $row->keterangan,
        ];
    }
