...
class TenagaKarhutExport  implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Tenaga Pengendalian Kebakaran Hutan',
            ...
            [
                ...
                '',
                '',
                'Manggala Agni PNS (Orang)',
                'Manggala Agni Non PNS (Orang)',
                'Jumlah Regu',
                'MPA (Orang)',
                '',
            ],
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $this->currentIndex,
            $row->satker_id,
            $row->manggala_agni_pns,
            $row->manggala_agni_nonpns,
            $row->jumlah_regu,
            $row->mpa,
            $row->keterangan,
        ];
