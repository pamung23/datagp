...
class PameranExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Promosi dan Publikasi Jasa Lingkungan Kawasan Konservasi',
            ...
            [
                ...
                'Jenis Publikasi dan Aktivitas Promosi',
                'Judul',
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $this->currentIndex,
            $row->satker_id,
            $row->jenis, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->judul, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->penyelenggara, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->sumber,
            $row->keterangan,
        ];
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('B6:H' . $highestRow)->getAlignment()->setHorizontal('center');
        $sheet->getStyle('B6:H' . $highestRow)->getAlignment()->setVertical('center');
