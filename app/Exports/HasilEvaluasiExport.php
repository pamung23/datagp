...
class HasilEvaluasiExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Hasil Evaluasi Kesesuaian Fungsi Kawasan Konservasi
                ',
    ...
    public function map($row): array
    {
        return [
            ...
            $row->tanggal, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->rekomendasi, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->tindak,
            $row->keterangan,
        ];
    }
