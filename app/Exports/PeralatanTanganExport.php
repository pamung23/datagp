...
class PeralatanTanganExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Peralatan Tangan Pengendalian Kebakaran Hutan',
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        foreach ($styles as $row => $style) {
            ...
            $sheet->getStyle('B' . $row . ':AB' . $row)->applyFromArray($style);
        }
        ...
        $sheet->getStyle('B7:AB' . $highestRow)->getAlignment()->setHorizontal('center');
        $sheet->getStyle('B7:AB' . $highestRow)->getAlignment()->setVertical('center');
