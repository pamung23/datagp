...
class PenataanBatasExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Penataan Batas Kawasan Konservasi',
            ...
            [
                ...
                '',
                '',
                'Kondisi Pal Batas / Rambu Suar (Jumlah)',
                '',
                'Jumlah Pal Batas',
                'Keterangan',
                '',
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('B6:N' . $highestRow)->getAlignment()->setHorizontal('center');
        $sheet->getStyle('B6:N' . $highestRow)->getAlignment()->setVertical('center');
