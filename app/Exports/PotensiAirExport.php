...
class PotensiAirExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Potensi Pemanfaatan Air di Kawasan Konservasi',
            ...
            [
                ...
                'Nama Sumber Air',
                'Debit (M3/Detik)',
                'Koordinat Sumber Air (Decimal Degree)',
                '',
                'Potensi Pemanfaatan (Air dan Energi Air)',
                '',
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $row->nama_sumber_air, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->debit, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
