...
class PeralatanTransportasiExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            [
                'Tabel : Peralatan Transportasi Pengendalian Kebakaran Hutan',
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('B7:W' . $highestRow)->getAlignment()->setHorizontal('center');
        $sheet->getStyle('B7:W' . $highestRow)->getAlignment()->setVertical('center');
