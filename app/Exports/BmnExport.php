...
class BmnExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function map($row): array
    {
        return [
            ...
            $row->nomor_urut,
            $row->satker_id,
            $row->kode, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->uraian, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->satuan, // Sesuaikan dengan nama kolom yang sesuai dengan data yang akan diekspor
            $row->kuantitas1,
            $row->nilai1,
            $row->kuantitas2,
            $row->nilai2,
